...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240429140017_add_mig_CompaniesScore")]
    partial class add_mig_CompaniesScore
    {
            ...
            modelBuilder.Entity("EntityLayer.Entities.CompaniesScore", b =>
                {
                    ...
                    b.Property<decimal>("CompanieScore")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("CompaniesInfoCompanieId")
                        .HasColumnType("int");

                    b.HasKey("CompaniesScoreId");

                    b.HasIndex("CompaniesInfoCompanieId");
            ...
            modelBuilder.Entity("EntityLayer.Entities.CompaniesScore", b =>
                {
                    b.HasOne("EntityLayer.Entities.CompaniesInfo", "CompaniesInfo")
                        .WithMany()
                        .HasForeignKey("CompaniesInfoCompanieId")
